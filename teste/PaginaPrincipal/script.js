    ...
    constructor() {
        ...
        this.textos = {
            pt: {
                ...
                'subtitulo-hero':'Sua jornada de bem-estar mental começa aqui',
                'descricao-hero':'Descubra um espaço seguro e acolhedor para cuidar da sua saúde mental. Com ferramentas práticas e personalizadas, o Mellius te acompanha em cada passo da sua jornada de autoconhecimento e bem-estar.',
                'sobre-mellius':'Sobre o Mellius',
                'paragrafo-destaque':'O Mellius nasceu da necessidade de tornar o cuidado com a saúde mental mais acessível, prático e efetivo. Nossa plataforma combina tecnologia moderna com práticas comprovadas de bem-estar.',
                'paragrafo-secundario':'Aqui você encontra um ambiente seguro para desenvolver hábitos saudáveis, acompanhar seu progresso emocional e descobrir ferramentas personalizadas que se adaptam ao seu ritmo de vida.',
                'citacao-destaque':'"Sua mente merece o melhor cuidado. \nNós estamos aqui para te ajudar nessa jornada."',
                'titulo-ferramentas':'Suas Ferramentas de Bem-estar',
                ...
                'desc-calendario-personalizado':'Organize sua rotina de autocuidado com lembretes inteligentes para meditação, exercícios e momentos de pausa. Acompanhe seu progresso diário e semanal.',
