...
<head>
    ...
    <title>Quiz de Lógica - Teste seu Raciocínio</title>
    ...
    <link rel="stylesheet" href="../../assets/css/logic_MathQuiz.css">
</head>
<body>
    <!-- Menu Toggle Button -->
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="sidebar-title">Menu Principal</div> 
                ...
                <!--Botão de quizzes-->
                <button class="sidebar-item" onclick="window.open('logic_quiz.php', '_self')">
                    <span class="sidebar-icon">🧩</span>
        ...
        <div class="quiz-card text-center">
            <div class="mb-8">
                ...
                <p class="subtitle" data-translate="welcome-subtitle">
                    Teste seu raciocínio lógico com perguntas de lógica clássica de forma divertida! 🤔
                </p>
            </div>
    ...
    <div id="results-screen" class="container hidden">
        <div class="quiz-card text-center">
            ...
            <div class="results-grid">
                <div class="stat-card">
                    <div id="score-value" class="stat-value">0/10</div>
    ...
    <!--Botão feito para linkar no script-->
    <script src="../../assets/js/math_quiz.js"></script>
</body>
</html>
